...
unset PCA_BENCH_EVALUATION_REPOSITORY PCA_BENCH_EVALUATORS PCA_BENCH_EVALUATOR_TIMEOUT PCA_BENCH_EVALUATION_PLAN PCA_BENCH_EVALUATION_OUTPUT PCA_BENCH_WORKER_RESULT 2>/dev/null || true
